...
function resolveImage(type: Type): string {
  return resolveAsset('Extensions', `${type}.png`);
}
...
function useServiceName(): ReactElement | undefined {
  ...
  if (serviceName) {
    ...
    switch (type) {
      case 'full':
        return SubLabel('Firebase Extensions');
      default:
        return SubLabel('Extensions');
    }
  }
  return undefined;
}

export const Extensions: FC<Props> = ({ name, type, children, ...dependences }) => {
  useAssertProvider();
