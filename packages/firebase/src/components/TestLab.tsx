...
function resolveImage(type: Type): string {
  return resolveAsset('TestLab', `${type}.png`);
}
...
function useServiceName(): ReactElement | undefined {
  ...
  if (serviceName) {
    ...
    switch (type) {
      case 'full':
        return SubLabel('Firebase Test Lab');
      default:
        return SubLabel('Test Lab');
    }
  }
  return undefined;
}

export const TestLab: FC<Props> = ({ name, type, children, ...dependences }) => {
  useAssertProvider();
