...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/migration-transfer/MigrationTransfer.png');
}
...
export const MigrationTransfer: FC<MigrationTransferProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
