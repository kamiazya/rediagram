...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/migration-transfer/CloudEndureMigration.png');
}
...
export const CloudEndureMigration: FC<CloudEndureMigrationProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
