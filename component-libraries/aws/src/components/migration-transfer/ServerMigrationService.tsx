...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/migration-transfer/ServerMigrationService.png');
}
...
export const ServerMigrationService: FC<ServerMigrationServiceProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
