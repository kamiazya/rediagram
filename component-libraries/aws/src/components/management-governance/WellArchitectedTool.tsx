...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/management-governance/WellArchitectedTool.png');
}
...
export const WellArchitectedTool: FC<WellArchitectedToolProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
