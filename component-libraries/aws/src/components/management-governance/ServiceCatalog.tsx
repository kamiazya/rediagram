...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/management-governance/ServiceCatalog.png');
}
...
export const ServiceCatalog: FC<ServiceCatalogProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
