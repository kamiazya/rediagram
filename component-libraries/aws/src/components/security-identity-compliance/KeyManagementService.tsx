...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/security-identity-compliance/KeyManagementService.png');
}
...
export const KeyManagementService: FC<KeyManagementServiceProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
