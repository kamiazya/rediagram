...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/security-identity-compliance/SecurityIdentityCompliance.png');
}
...
export const SecurityIdentityCompliance: FC<SecurityIdentityComplianceProps> = ({
  name,
  children,
  upstream,
  downstream,
