...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/cost-management/CostAndUsageReport.png');
}
...
export const CostAndUsageReport: FC<CostAndUsageReportProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
