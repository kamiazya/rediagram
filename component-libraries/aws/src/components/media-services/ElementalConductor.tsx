...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/media-services/ElementalConductor.png');
}
...
export const ElementalConductor: FC<ElementalConductorProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
