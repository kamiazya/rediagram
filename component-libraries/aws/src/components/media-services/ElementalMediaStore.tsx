...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/media-services/ElementalMediaStore.png');
}
...
export const ElementalMediaStore: FC<ElementalMediaStoreProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
