...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/media-services/ElementalMediaConvert.png');
}
...
export const ElementalMediaConvert: FC<ElementalMediaConvertProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
