...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/media-services/ElementalMediaLive.png');
}
...
export const ElementalMediaLive: FC<ElementalMediaLiveProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
