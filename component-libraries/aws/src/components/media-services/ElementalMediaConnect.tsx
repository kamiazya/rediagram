...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/media-services/ElementalMediaConnect.png');
}
...
export const ElementalMediaConnect: FC<ElementalMediaConnectProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
