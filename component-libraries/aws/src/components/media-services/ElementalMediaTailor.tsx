...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/media-services/ElementalMediaTailor.png');
}
...
export const ElementalMediaTailor: FC<ElementalMediaTailorProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
