...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/networking-content-delivery/PrivateLink.png');
}
...
export const PrivateLink: FC<PrivateLinkProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
