...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/networking-content-delivery/TransitGateway.png');
}
...
export const TransitGateway: FC<TransitGatewayProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
