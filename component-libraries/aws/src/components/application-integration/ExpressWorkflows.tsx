...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/application-integration/ExpressWorkflows.png');
}
...
export const ExpressWorkflows: FC<ExpressWorkflowsProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
