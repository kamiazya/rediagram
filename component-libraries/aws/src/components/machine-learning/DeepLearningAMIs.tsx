...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/machine-learning/DeepLearningAMIs.png');
}
...
export const DeepLearningAMIs: FC<DeepLearningAMIsProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
