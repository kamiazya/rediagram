...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/machine-learning/ElasticInference.png');
}
...
export const ElasticInference: FC<ElasticInferenceProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
