...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/internet-of-things/IoTThingsGraph.png');
}
...
export const IoTThingsGraph: FC<IoTThingsGraphProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
