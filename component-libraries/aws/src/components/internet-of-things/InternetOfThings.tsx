...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/internet-of-things/InternetOfThings.png');
}
...
export const InternetOfThings: FC<InternetOfThingsProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
