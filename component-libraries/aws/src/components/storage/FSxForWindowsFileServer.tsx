...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/storage/FSxForWindowsFileServer.png');
}
...
export const FSxForWindowsFileServer: FC<FSxForWindowsFileServerProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
