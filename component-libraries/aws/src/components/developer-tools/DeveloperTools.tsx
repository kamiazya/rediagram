...
function resolveImage(): string {
  return resolve(__dirname, '../../../assets/developer-tools/DeveloperTools.png');
}
...
export const DeveloperTools: FC<DeveloperToolsProps> = ({ name, children, upstream, downstream }) => {
  useAssertProvider();
  const icon = useIcon();
